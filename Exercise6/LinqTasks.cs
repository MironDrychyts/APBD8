...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            var methodSyntax =
                Emps
                    .Where(e => e.Salary.Equals(Emps.Max(e1 => e1.Salary)));
        ...
        {
            var methodSyntax = 
                Emps.GroupBy(e1 => e1.Job).Select(e => new { Praca = e.Key, LiczbaPracownikow = e.Count()} );
        ...
        {
            var methodSyntax = Emps.Where(e => e.Job == "Frontend programmer").OrderByDescending(e => e.HireDate).FirstOrDefault();
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            IEnumerable<object> result = empsList.Union(fixedValue);
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            var methodSyntax =  Depts.Where(g => Emps.Count(e => e.Deptno.Equals(g.Deptno)) > 1)
                .Select(g => new 
                { 
                    name = g.Dname, 
                    numOfEmployees = Emps.Count(e => e.Deptno.Equals(g.Deptno)) 
                });
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.AllEmpsWithEmps(Emps);
            return result;
        }
        ...
        {
            var methodSyntax = Depts.Where(g =>
                Emps.Count(e => e.Deptno.Equals(g.Deptno)) == 5 || Emps.Count(e => e.Deptno.Equals(g.Deptno)) == 0).OrderBy(e => e.Dname);
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> AllEmpsWithEmps(IEnumerable<Emp> Emps)
        {
            var methodSyntax = Emps.Where(e => Emps.Any(e1 => e1.Mgr == e)).OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
